import { _decorator, Node, Vec3, Vec2, Color, MeshRenderer, randomRangeInt, tween, Tween, v3, director, Sprite, Component, geometry, GeometryRenderer, IVec3, Quat, IVec3Like, PhysicsSystem, Mat4, quat, renderer } from 'cc';
import { fun } from './fun';
